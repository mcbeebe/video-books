...
- 2026-04-29 feat(cli,content): wire `wcap render` end-to-end (orchestrator → assembler), add 3-scene Muir fixture in `content/chapters/`, `content/style-anchors/wilderness-v1.txt`, integration test with mock providers exercises full render path (architecture §4, §6.6-§6.8)
