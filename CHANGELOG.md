...
- 2026-04-29 docs(runbook,api-keys,arch): add `docs/RUNBOOK.md`, `docs/API_KEYS.md`, `docs/ARCHITECTURE.md` index; feat(scripts): smoke scripts for narration / image / video gated on API keys; chore(claude): mark Phase 1 tasks 1-10 complete
