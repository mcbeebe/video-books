...
- 2026-04-29 feat(video-gen): provider-routed video client (kling / seedance / veo configs), `pickProvider(scene)` HERO→veo router, data-URL image inlining (architecture §6.4)
